...
import Speaker1 from "../../assets/img/faces/marc.jpg"
    ...
    <div style={{ width: "80%" }}>
        ...
        <div className="row">
            <div
                ...
                <img src={Speaker1} alt={"Keynote Speaker I"} className="img-responsive"
                    style={{
                        maxHeight: "200px",
                        maxWidth: "200px"
                    }} />
            ...
            <div
                ...
                <h6>Fellow of the European AI community (EurAI)</h6>
            </div>
            <div >
                ...
                <p style={{ fontSize: "16px" }}>F
                    Van den Herik has been active in many organizations and advisory boards, such as the Belgian Netherlands Association of AI (honorary member), JURIX (honorary chair), the CSVN (honorary member), the ICGA, ToKeN, Catch, the consortium BiG Grid, and Legal Delta. Furthermore, he is a fellow of the European AI community (EurAI), and member of the Royal Holland Society of Sciences and Humanities. Currently he employs with the LCDS team mates initiatives in The Hague to start an Executive Master on Legal Technologies.</p>
            </div>
        </div>
        <div className="row">
            <div className="col-sm-4">
